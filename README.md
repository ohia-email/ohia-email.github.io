...
**Website:** https://jgkarlin.github.io/
...
Content can be edited directly on GitHub. GitHub Pages publishes the `main` branch using a built-in theme; no application build is needed.
